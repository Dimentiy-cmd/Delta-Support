...
**Веб-панель**
- Чаты в реальном времени (WebSocket с автопереподключением), поиск по имени/username/Telegram ID, счётчики на фильтрах
- Звуковое уведомление на новую эскалацию/сообщение клиента — включается/выключается одной кнопкой в шапке
